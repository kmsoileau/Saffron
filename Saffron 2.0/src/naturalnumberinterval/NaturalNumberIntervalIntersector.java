		...
		IProblem
{
	...
	{
		IProblem pX0X1 = new NaturalNumberOrderer(theOne.getLower(), theOne.getUpper());
		IProblem pY0X0 = new NaturalNumberOrderer(theOther.getLower(), theOne.getLower());
		IProblem pX0Y1 = new NaturalNumberOrderer(theOne.getLower(), theOther.getUpper());
		IProblem pY0X1 = new NaturalNumberOrderer(theOther.getLower(), theOne.getUpper());
		IProblem pX1Y1 = new NaturalNumberOrderer(theOne.getUpper(), theOther.getUpper());
		IProblem pY0Y1 = new NaturalNumberOrderer(theOther.getLower(), theOther.getUpper());
		IProblem pX0Y0 = new NaturalNumberOrderer(theOne.getLower(), theOther.getLower());
		IProblem pY1X1 = new NaturalNumberOrderer(theOther.getUpper(), theOne.getUpper());
