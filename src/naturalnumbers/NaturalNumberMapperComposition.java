...
{
	public NaturalNumberMapperComposition(NaturalNumberMapper first, NaturalNumberMapper second, INaturalNumber X,
			INaturalNumber Y) throws Exception
	{
		...
		{ new NaturalNumberEqualizer(X, first.getDomainVariable()), first,
				new NaturalNumberEqualizer(first.getRangeVariable(), second.getDomainVariable()), second,
