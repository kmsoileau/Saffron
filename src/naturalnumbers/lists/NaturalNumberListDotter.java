...
{
	public NaturalNumberListDotter(INaturalNumberList list1,
			INaturalNumberList list2, INaturalNumber dotProduct)
			throws Exception
	{
		...
		{
			p.add(new NaturalNumberMultiplier(list1.getNaturalNumber(i), list2
					.getNaturalNumber(i), subProduct.getNaturalNumber(i)));
		}

		IProblem problem = new Conjunction(new Conjunction(p),
				new NaturalNumberListTotaler(subProduct, dotProduct));
