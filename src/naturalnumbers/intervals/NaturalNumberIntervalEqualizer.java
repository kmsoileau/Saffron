...
{
	public NaturalNumberIntervalEqualizer(INaturalNumberInterval A, INaturalNumberInterval B) throws Exception
	{
		if (A == null || B == null)
			throw new NaturalNumberIntervalEqualizerException(
					"A null INaturalNumberInterval was passed to constructor.");
		IProblem p = new Conjunction(new NaturalNumberEqualizer(A.getLower(), B.getLower()),
