...
public class NaturalNumberStrictOrderer extends Problem implements IProblem
{
	...
	public NaturalNumberStrictOrderer(INaturalNumber X, INaturalNumber Y) throws Exception
	{
		...
		INaturalNumber XX = new NaturalNumber("NaturalNumberStrictOrderer-" + nNSOCount++);
	...
	public NaturalNumberStrictOrderer(INaturalNumber X, long y) throws Exception
	{
		INaturalNumber dummy = new NaturalNumber("NaturalNumberStrictOrderer-" + nNSOCount++);
		IProblem p1 = new NaturalNumberFixer(dummy, y);
		IProblem p2 = new NaturalNumberStrictOrderer(X, dummy);
		this.setClauses(new Conjunction(p1, p2).getClauses());
	}

	public NaturalNumberStrictOrderer(long x, INaturalNumber Y) throws Exception
	{
		INaturalNumber dummy = new NaturalNumber("NaturalNumberStrictOrderer-" + nNSOCount++);
