...
public class MagmaFixer extends Problem implements IProblem
{
	public MagmaFixer(Magma mgm) throws Exception
	{
		...
		HashMap<INaturalNumber, HashMap<INaturalNumber, INaturalNumber>> hm1 = mgm.getComposition();
		...
		for (INaturalNumber e1 : hm1.keySet()) // order
		{
			...
			{
				p[index++] = new Conjunction(new NaturalNumberFixer(e2), new NaturalNumberFixer(curr.get(e2)));
			}
		}
