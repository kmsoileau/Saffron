 ...
 * @since 2007/08/22
 */
public class ExclusiveDisjunction extends bits.Problem implements IProblem
{
	...
	public ExclusiveDisjunction(List<IProblem> list) throws Exception
	{
		...
		else
		{
			...
			IProblem problem2 = new bits.Problem(problem1);
			for (int i = 1; i < list.size(); i++)
				problem2 = new Conjunction(problem2, new bits.ProblemDenier(list.get(i)));

			IProblem problem3 = new bits.ProblemDenier(problem1);
