...
{
	/*
	 * public SetIntersector(Set X, Set Y, Set Z) throws Exception { if (X == null
	 * || Y == null || Z == null) throw new SetIntersectorException(
	 ...
	 * this.setClauses(unsolvableProblem().getClauses()); else { IProblem problem =
	 * Problem.newProblem(); for (Object o : xSupport) { if (ySupport.contains(o)) {
	 * zSupport.add(o); problem = new Conjunction(problem, new Disjunction( new
	 * BitFixer(X.contains(o), false), new BitFixer( Y.contains(o), false), new
	 * BitFixer( Z.contains(o), true))); } } this.setClauses(problem.getClauses());
	 * } }
	 */
}
