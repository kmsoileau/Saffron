...
public class SetIntersector extends Problem implements IProblem
{
	 ...
	 * this.setClauses(Problem.unsolvableProblem().getClauses()); else { IProblem
	 * problem = Problem.newProblem(); for (Object o : xSupport) { if
	 * (ySupport.contains(o)) { zSupport.add(o); problem = new Conjunction(problem,
	 * new Disjunction( new BitFixer(X.contains(o), false), new BitFixer(
	 * Y.contains(o), false), new BitFixer( Z.contains(o), true))); } }
