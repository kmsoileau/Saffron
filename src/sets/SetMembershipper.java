...
public class SetMembershipper extends Problem implements IProblem
{
	...
	{
		if (set == null)
			throw new SetMembershipperException("Null passed to constructor as Set parameter.");
		if (object == null)
			throw new SetMembershipperException("Null passed to constructor as Object parameter.");
		IBooleanVariable bv = set.contains(object);

		if (bv == null)
			throw new SetMembershipperException("Object " + object + " is not in the support of Set " + set);
