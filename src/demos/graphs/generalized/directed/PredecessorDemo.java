...
public class PredecessorDemo extends Problem implements IProblem
{
	public static void main(String[] args) throws Exception
	{
		...
		{
			System.out.println("vertex " + curr.getName() + " has value "
					+ curr.getValue() + " and hashCode " + curr.hashCode());
		}

		HashMap<INaturalNumber, HashMap<INaturalNumber, IBooleanVariable>> lu = graph
				.getLookup();
		...
		IProblem problem = new Conjunction(new GraphFixer(graph),
				new NaturalNumberFixer(pred), new NaturalNumberFixer(succ),
				new GraphEdger(graph, pred, succ));
