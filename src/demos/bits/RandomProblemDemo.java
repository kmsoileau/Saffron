...
public class RandomProblemDemo
{
	static Object[] convert(IClause c)
	{
		...
		return new Object[] {barredSet,unBarredSet};
	}
	...
	public static void main(String[] args) throws Exception
	{
		IBooleanVariable[] bv=new IBooleanVariable[] {
				...
				BooleanVariable.getBooleanVariable("e"),
				BooleanVariable.getBooleanVariable("f"),
				BooleanVariable.getBooleanVariable("g"),
				BooleanVariable.getBooleanVariable("h"),
				BooleanVariable.getBooleanVariable("i"),
				BooleanVariable.getBooleanVariable("j")
				};
