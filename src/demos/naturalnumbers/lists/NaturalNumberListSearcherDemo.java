...
public class NaturalNumberListSearcherDemo
{
	public static void main(String[] args) throws Exception
	{
		...
		IProblem problem = new Conjunction(new Conjunction(
				new NaturalNumberFixer(searchFor), new NaturalNumberListFixer(
						data)), new NaturalNumberListSearcher(data, searchFor,
				result), new BitArrayTotaler(result, occurrences));
