...
public class NaturalNumberListDotterDemo
{
	public static void main(String[] args) throws Exception
	{
		...
		{ new NaturalNumber(1), new NaturalNumber(2), new NaturalNumber(3), new NaturalNumber(4), new NaturalNumber(5),
				new NaturalNumber(6), new NaturalNumber(7), new NaturalNumber(8), new NaturalNumber(9) });

		INaturalNumber dotProduct = new NaturalNumber();

		IProblemMessage s = new Conjunction(new NaturalNumberListFixer(list1), new NaturalNumberListFixer(list2),
				new NaturalNumberListDotter(list1, list2, dotProduct)).findModel(Problem.defaultSolver());
