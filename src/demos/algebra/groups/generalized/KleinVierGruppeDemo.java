 ...
 *
 */
public class KleinVierGruppeDemo
{
	public static void main(String[] args) throws Exception
	{
		...
		Grouper group = new Grouper(opTable, E1, E2, E3);

		System.out.println(group);

		IProblem problem = new Conjunction(group, new NaturalNumberFixer(E1, 1), new NaturalNumberFixer(E3, 2));
